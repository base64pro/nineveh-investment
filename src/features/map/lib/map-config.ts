...
export const NAVY = { background: "#070d18", water: "#050b14" };

// تعتيم محيط نينوى (§هـ.4 — «ما حولها معتم») — أخفّ قليلاً ليتوحّد غمق الأرضية داخل نينوى وخارجها
export const DIM_COLOR = "rgba(5,9,16,0.38)";
