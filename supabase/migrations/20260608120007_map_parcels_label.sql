-- م2.4 · إضافة عنوان العرض (label) لقطع الخريطة: اسم المفترضة، أو عنوان الفرصة/الرخصة، أو رقم القطعة.
...
left join lateral (
  select l.status, l.title from licenses l
...
comment on view map_parcels is 'قطع الخريطة الموحّدة (هندسة GeoJSON + الحالة + العنوان) للعرض — م2.4.';
