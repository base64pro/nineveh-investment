-- مراجعة م6 · إصلاح: النقل يرحّل نتائج الذكاء المثبّتة (parcel_insights) مع القطعة —
-- لا تُفقَد التوصيات/المعايير المثبّتة عند الانتقال بين الأنواع (§هـ.4 «تُثبَّت كبيانات للقطعة»).
