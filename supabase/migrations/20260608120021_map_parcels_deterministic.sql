-- مراجعة م6 · إصلاح: map_parcels حتمية — عند تعدد كيانات بنفس (parcel_no, muqataa_no)
-- يُختار الأحدث (record_id الأكبر) بدل limit 1 الاعتباطي (لون/كيان غير حتمي).
...
comment on view map_parcels is 'قطع الخريطة الموحّدة (هندسة + حالة + عنوان + entity_id) — اختيار حتمي للأحدث عند التعدد.';
