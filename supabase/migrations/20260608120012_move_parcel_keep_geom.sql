-- م3.5+ · إصلاح فقدان الرسم: عند ترقية مفترضة مرسومة **بلا رقم قطعة** إلى فرصة/رخصة،
-- يُولَّد رقم قطعة مؤقّت ('مرسومة-<id>') ليبقى الرسم مرتبطاً بالسجلّ الجديد (parcel_geometry بالمطابقة على parcel_no).
